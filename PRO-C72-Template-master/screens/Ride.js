    ...
    db.collection('bicycles')
      ...
      .then((doc) => {
        ...
        if (bike.is_bike_available) {
          ...
          {/* show(
            'You have rented the bike for next 1 hour. Enjoy your ride!!',   1
            ToastAndroid.SHORT
          );*/}

          {/* ToastAndroid.show(
            'You have rented the bike for next 1 hour. Enjoy your ride!!',   2
            ToastAndroid
          );*/}

          {/* ToastAndroid.show(
            'You have rented the bike for next 1 hour. Enjoy your ride!!',   3
             SHORT
          );*/}

           ToastAndroid.show(
            'You have rented the bike for next 1 hour. Enjoy your ride!!',   4
            ToastAndroid.SHORT
          );
